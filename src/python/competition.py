...
WIKI_MEDIUM_RANGE_FACETS_ALL = Data("wikimediumall", constants.WIKI_MEDIUM_DOCS_LINE_FILE, constants.WIKI_MEDIUM_DOCS_COUNT, constants.WIKI_MEDIUM_RANGE_FACETS_TASKS_10MDOCS_FILE)
...
DATA = {
  ...
  "rangeFacetsWikimediumAll": WIKI_MEDIUM_RANGE_FACETS_ALL,
}
